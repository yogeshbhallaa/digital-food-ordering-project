 ...
 * @author Main-Hall
 */
public class adminvieworder extends javax.swing.JFrame {
    ...
    void loadorders() {
        try {
            HttpResponse<String> res = Unirest.get("http://localhost:8888/getorder").asString();
        ...
        jpanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jpanel1Layout.createSequentialGroup()
                .addGroup(jpanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jpanel1Layout.createSequentialGroup()
                        .addGap(171, 171, 171)
                        .addComponent(btconf, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(125, 125, 125)
                        .addComponent(btcanc, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jpanel1Layout.setVerticalGroup(
            ...
            .addGroup(jpanel1Layout.createSequentialGroup()
                ...
                .addGroup(jpanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btconf, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btcanc, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void updateorder(String status) {
        ...
        if (index == -1) {
            ...
            int showConfirmDialog = JOptionPane.showConfirmDialog(rootPane, "Are you sure?","Confirmation",JOptionPane.OK_CANCEL_OPTION);
            if (showConfirmDialog == JOptionPane.OK_OPTION) {
                String billid = alorder.get(index).billid;
                String mobileno = alorder.get(index).mobile;
                String  billamount = alorder.get(index).billamount;
                System.out.println("billid " + billid);
                jpanel1.setVisible(true);
                try {
                    HttpResponse<String> res = Unirest.get("http://localhost:8888/updateorder")
                            .queryString("billid", billid)
                    ...
                    if(response.equals("success"))
                    {
                         ...
                         {
                             smstext = "Your order having order no " + billid + " and amount " +  billamount +" is confirmed. it will be ready within 20 - 30 mins.";
                         }
                         else
                         {
                             smstext = "Your order having order no " + billid + " and amount " +  billamount +" is canceled due to non availablity of items. sorry for in convience";
                         }
                         sendsms.send(mobileno, smstext);
                    }
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
